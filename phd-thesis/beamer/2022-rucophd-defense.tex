...
\pgfdeclareimage[height=1cm]{mainlogo}{/media/labfiles/ruco/phd-ssp/phd-thesis/figures/title-page/iicologo} % placed in the upper left/right corner
...
\institute[
{	\vspace{-0.3cm}
	\includegraphics[scale=0.08]{../figures/title-page/uaslplogo} 
}
