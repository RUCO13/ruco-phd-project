...
\node<2>[anchor=north west,yshift=0mm,scale=0.55](h1) at (e1.south west){
...
\node<2>[anchor=south west,text width=0.5\textwidth] at (h1.north west) {Hamiltoniano Tight-Binding $sp^{3}s^{*}$};
\node<2>[anchor=south west,text width=\textwidth,scale=0.75] at (current page.south west){\emph{Vogl, P., Hjalmarson, H. P., \& Dow, J. D. (1983). A semi-empirical tight-binding theory of the electronic structure of semiconductors. Journal of physics and chemistry of solids, 44(5), 365-378.}};
...
\node<3->[anchor=north west,inner sep=0mm,yshift=-8mm](b02) at (current page.north west){\includegraphics[width=0.28\textwidth]{../../figures/chapter-1/bands/build/bands02}};

\node<4->[anchor=north west,inner sep=0mm,xshift=7mm,yshift=-2mm](b03) at (b02.north east){\includegraphics[width=0.33\textwidth]{../../figures/chapter-1/exciton-1/build/x-1}};
\end{tikzpicture}
\end{frame}
