...
\node<4->[anchor=south west,yshift=0cm,inner sep=0mm](g2) at (current page.south west){\animategraphics[autoplay,loop,trim = {0cm 0cm 0cm 0cm},width=\textwidth,palindrome]{25}{beamer-figures/introduction/build-ruco/blochs}{}{}};
