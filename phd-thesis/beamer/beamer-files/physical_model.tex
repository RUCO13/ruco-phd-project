...
\node<4>[anchor=north west,xshift=15mm,yshift=2mm] at (txt.south) {\includegraphics[width=0.4\linewidth]{beamer-figures/physical-model/build-ruco/m43523-ioa.pdf}};
...
\node<5>[anchor=north west,xshift=15mm,yshift=2mm] at (txt.south) {\includegraphics[width=0.4\linewidth]{beamer-figures/physical-model/build-ruco/m43521-ioa.pdf}};
