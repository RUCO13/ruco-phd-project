...
\node<1->[anchor = north west, text width =0.7\textwidth, yshift = -0.75cm](txt) at (current page.north west) {
	...
	\item<2-> Simetr\'ia ``Microscopica''.
	
	\end{itemize}
	\end{tcolorbox}	
};

\node<1->[anchor=north west,inner sep=0mm,xshift=0mm,yshift=-5mm](sym1) at (txt.north east){\animategraphics[autoplay,loop,width=0.3\textwidth,autoresume]{5}{beamer-figures/physical-model/sym9}{}{}};
