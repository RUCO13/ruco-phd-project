...
\node[at=(current page.center),
      ...
      fill=none,
      inner sep=0pt,
     ]  {\includegraphics[width=\paperwidth,]{../figures/chapter-2/symmetry/build-ruco/sym-back.pdf}};
...
at (current page.north east) {\includegraphics{../figures/title-page/iicologo.png}};
...
at (current page.north west) {\includegraphics{../figures/title-page/uaslplogo.png}};      
