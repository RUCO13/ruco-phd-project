...
\begin{tikzpicture}[remember picture,overlay,xshift=-0.1cm]
    ...
    \begin{scope}[rotate around y=0]
        \draw[transform shape,line width=0.5mm] (0,-0.5)--++(1,0)--++(0,-3)--++(1.1,0)--++(0,3)--++(0.2,0)--++(0,-3)--++(2,0)--++(0,3)--++(1,0);
...
%        \draw[-{[scale=1.5]Stealth},line width=0.3mm,red] (0.8,-4.3)--++(3,0);
    \end{scope}
\node[scale=1.5,blue] at (2.1,0) {$d_{1}<d_{2}$};
\node[scale=1.3,blue] at (3.3,-0.75) {$d_{2}\!=\!2d_{1}$};
