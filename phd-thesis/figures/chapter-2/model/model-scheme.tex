...
\node [draw=shinee,circle,inner sep=-0.3mm,align=center,ball color=cyan,scale=8,opacity=0](c0) at ([xshift=-4cm]current page.center) {$\displaystyle C_{2v}$};


\node [draw=shinee,circle,inner sep=0mm,inner sep=-3mm,line width=.5mm](c1) at ([xshift=5cm]c0.east) {\includegraphics[scale=0.7]{build-ruco/acqws-2.pdf}};
\def\arcccu{235}
\def\arcccd{55}

\draw[color=shinee,right color=shinee,middle
color=shinee,fill opacity=0.3,line width=.5mm,draw opacity=1,rounded corners,inner sep=0mm]  
(c0.south east) to [bend left] (c1.south west)  arc (225:140:2.3) -- 
(c1.north west) to [bend left] (c0.north east) arc (45:-45:2.25);


\node [draw=blue!60,circle,inner sep=0mm,inner sep=-3mm,line width=.5mm](c2) at ([xshift=2.5cm,yshift=3.5cm]c0.north east) {\includegraphics[scale=0.7]{build-ruco/acqws-1}};

\draw[color=blue!60,top color=white, bottom
color=blue!70!white,fill opacity=0.3,line width=.5mm,draw opacity=1,rounded corners,inner sep=0mm]  
(c0.east) to [bend left] (c2.south) arc (270:170:2.3)--
(c2.west) to [bend left] (c0.north) arc (90:0:2.3);

\node [draw=red!60,circle,inner sep=0mm,inner sep=-3mm,line width=.5mm](c3) at ([xshift=2.5cm,yshift=-3.5cm]c0.south east) {\includegraphics[scale=0.7]{out/scqws}};
...
\begin{scope}
\node [draw=shinee,circle,inner sep=-0.3mm,align=center,ball color=cyan,scale=8,opacity=1](c0) at ([xshift=-4cm]current page.center) {$\displaystyle C_{2v}$};
