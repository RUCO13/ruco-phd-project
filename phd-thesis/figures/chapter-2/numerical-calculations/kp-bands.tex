...
% \pgfplotstableread[col sep=comma]{ruco/repos/kp-lflm-group/data/BandStructure_GaAs_1.dat}\bands
...
{
/media/labfiles/ruco/repos/kp-lflm-group/data/Ex.dat
};
...
% every mark/.append style={line width=1pt,mark size=4pt,fill=blue!80!black},
% line width=1pt+0.5pt*\pgfplotspointmetatransformed/1000,
% ] table[x index=0,y index=\x,col sep=tab]{/media/labfiles/ruco/repos/kp-lflm-group/data/BandStructure_GaAs_1.dat};
...
% \errorband{/media/labfiles/ruco/repos/kp-lflm-group/data/BandStructure_GaAs_1.dat}{0.4}
