...
%================================  PLOT  VB      
       ...
       %%%================================= Add Data ===================================
       \pgfplotstableread[col sep=comma]{/media/labfiles/ruco/phd-ssp/numerical-results/data/m43172-band-edge.txt}{\vp};
	   \pgfplotstableread[col sep=comma]{/media/labfiles/ruco/phd-ssp/numerical-results/data/m43172-wf-hh.txt}{\psihh};
	   \pgfplotstableread[col sep=comma]{/media/labfiles/ruco/phd-ssp/numerical-results/data/m43172-wf-lh.txt}{\psilh}
        ...
        \coordinate (pos1) at (axis cs:42.082
        ,-0.075);        
        \end{axis}
...
%================================  PLOT  CB         
       ...
       %%%================================= Add Data ===================================
       \pgfplotstableread[col sep=comma]{/media/labfiles/ruco/phd-ssp/numerical-results/data/m43172-band-edge.txt}{\vp};
	   \pgfplotstableread[col sep=comma]{/media/labfiles/ruco/phd-ssp/numerical-results/data/m43172-wf-e.txt}{\psie};
    ...
    \coordinate (pos2) at (axis cs:42.082
    ,1.65);
