...
\node[anchor=north west,inner sep=0mm] at (current page.north west){\includegraphics[width=0.49\linewidth]{out/numerical-results-m43523}};
\node[anchor=north east,inner sep=0mm] at (current page.north east){\includegraphics[width=0.49\linewidth]{out/numerical-results-m43522}};
\node[anchor=south west,inner sep=0mm] at (current page.south west){\includegraphics[width=0.49\linewidth]{out/numerical-results-m43521}};
\node[anchor=south east,inner sep=0mm] at (current page.south east){\includegraphics[width=0.49\linewidth]{out/numerical-results-m43172}};
