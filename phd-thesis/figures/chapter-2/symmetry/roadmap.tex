...
\node[scale=1.25,blue,xshift=-0mm,font=\bf] at (c1.north west){(a)};
...
([xshift=2mm,yshift=-2.1mm]c11.north west) to [bend right]  ([xshift=-8mm,yshift=2.1mm]c1.south);
 ...
 \draw ([yshift=3cm]c1.north) circle [radius=1cm] node[anchor=center,text width=1.7cm] (c12){\includegraphics[width=\textwidth]{c2v-types/out/c2v-5}};
 \def\angcud{217}
 \def\angcudd{38}
\draw[inner sep=0mm, color=green!60,right color=green,middle color=blue,opacity=0.5,]
...
\draw ([yshift=3cm]c0.north) circle [radius=1cm] node[anchor=center,text width=1.7cm] (c2){\includegraphics[width=\textwidth]{c2v-types/out/c2v-3}};
...
\draw ([xshift=2.5cm]c0.east) circle [radius=1cm] node[anchor=center,text width=1.7cm] (c3){\includegraphics[width=\textwidth]{c2v-types/out/c2v-4}};
\def\arcccu{234}
\def\arcccd{53}
...
\node[scale=1.25,blue,xshift=-1mm,font=\bf] at (c3.north west){(b)};
...
\node[scale=1.25,blue,xshift=-1mm,font=\bf] at (c4.north west){(c)};
