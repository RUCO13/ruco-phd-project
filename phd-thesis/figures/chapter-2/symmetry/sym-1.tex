...
\node[xshift=-1.95cm,yshift=-0.5cm](a1) at (current page.center){\includegraphics[width=0.17\textwidth]{/media/labfiles/ruco/phd-ssp/phd-codes/symmetry/algaas-interface-0-out.pdf}};

\node[anchor = west,xshift=1cm,yshift=0.0cm](a2) at (a1.east){\includegraphics[width=0.17\textwidth]{/media/labfiles/ruco/phd-ssp/phd-codes/symmetry/algaas-interface-1-out.pdf}};
