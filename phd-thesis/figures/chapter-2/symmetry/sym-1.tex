...
\node[anchor=center](s1) at (current page.center){\includegraphics[width=\textwidth]{/media/labfiles/ruco/phd-ssp/phd-codes/atom-structures/symmetry3-algaas}};
...
\shade [ball color=Al] ([xshift=5mm,yshift=16mm]s1.west) circle (0.35) node[label=right:{\Large\, Al}] { } ;
