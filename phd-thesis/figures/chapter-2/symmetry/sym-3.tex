...
\node[xshift=0mm,yshift=0mm](a1) at (3.8,-1){\includegraphics[width=0.09\textwidth]{/media/labfiles/ruco/phd-ssp/phd-codes/symmetry/algaas-interface-1-out.pdf}};

\node[anchor = center,xshift=0mm,yshift=0mm](a2) at (3.8+3,-1){\includegraphics[width=0.09\textwidth]{/media/labfiles/ruco/phd-ssp/phd-codes/symmetry/algaas-interface-0-out.pdf}};

\node[anchor=center,xshift=0mm,yshift=0mm](a3) at (3.8+3+1,-1){\includegraphics[width=0.09\textwidth]{/media/labfiles/ruco/phd-ssp/phd-codes/symmetry/algaas-interface-1-out.pdf}};

\node[anchor = center,xshift=0mm,yshift=0mm](a4) at (3.8+3+1+1.2,-1){\includegraphics[width=0.09\textwidth]{/media/labfiles/ruco/phd-ssp/phd-codes/symmetry/algaas-interface-0-out.pdf}};
\end{scope}
