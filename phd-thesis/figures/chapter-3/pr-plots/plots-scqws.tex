...
\begin{document}
	\begin{tikzpicture}
		\begin{axis}[scale only axis,
			...
			\pgfplotstableread[col sep=comma]{/media/labfiles/ruco/cqws-codes/cqws/data/potentials-m43523.txt}{\vp};
			
			\pgfplotstableread[col sep=comma]{/media/labfiles/ruco/cqws-codes/cqws/data/psi-hh-m43523.txt}{\hh};
			\addlegendentry[yshift = -0.3mm,opacity = 1]{hh2};
			\pgfplotstableread[col sep=comma]{/media/labfiles/ruco/cqws-codes/cqws/data/psi-lh-m43523.txt}{\lh};
		...
		\begin{axis}[%
			...
			%=================================== Add Data ===================================
			\pgfplotstableread[col sep=comma]{/media/labfiles/ruco/cqws-codes/cqws/data/potentials-m43523.txt}{\vp};			
			\pgfplotstableread[col sep=comma]{/media/labfiles/ruco/cqws-codes/cqws/data/psi-e-m43523.txt}{\e};
			%
			...
			\draw[{Stealth[scale=0.5]}-{Stealth[scale=0.5]},color=Spectral-E] (axis cs:313.85,1.62)--(axis cs:325.72,1.62);
		\end{axis}
	\end{tikzpicture}
\end{document}
