...
\begin{document}
	...
	\begin{tikzpicture}
		\begin{axis}[scale only axis,
			...
			\node[anchor=north west,inner sep=-0.1mm] at (axis description cs:0,1.0){\includegraphics{/media/labfiles/ruco/analisis/by-groups/cqws/build/plots-scqws.pdf}};
			
			\node[anchor=north east,inner sep=-0.1mm] at (axis description cs:1.0,1.0){\includegraphics{/media/labfiles/ruco/analisis/by-groups/cqws/build/plots-acqws-1.pdf}};
%			
%			
