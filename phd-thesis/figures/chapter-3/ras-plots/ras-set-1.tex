...
\begin{groupplot}[scale only axis,
	...
	\def\sc{0.7}
	\bandt{1.5295}{3e-4}{0e-4}{$\mathrm{\thh{1}{1}}$}{3}{\sc}{Dark2-A}
	\bandt{1.5351}{3e-4}{0e-4}{$\mathrm{\tlh{1}{1}}$}{3}{\sc}{Dark2-A}
	...
	\draw (axis cs:0,0)--(axis cs:1.5025,0);
	\def\sc{0.7}
	\bandt{1.5343}{-3e-4}{-0.5e-4}{$\mathrm{\thh{1}{1}}$}{-4}{\sc}{Dark2-B}
	\bandt{1.5425}{-3e-4}{-0.5e-4}{$\mathrm{\tlh{1}{1}}$}{-4}{\sc}{Dark2-B}
	...
	\bandt{1.51}{-3e-4}{-1.2e-4}{Substrate}{1}{0.5}{black};

	\def\sc{0.7}
	\bandt{1.5340}{5e-4}{1.2e-4}{$\thh{1}{1}$}{2}{\sc}{Dark2-C}
	\bandt{1.5417}{-5e-4}{-0.5e-4}{$\tlh{1}{1}$}{-5}{\sc}{Dark2-C}
...
\begin{groupplot}[scale only axis,
	...
	\addplot[color=Dark2-A] table[x index=0,y expr=\thisrowno{1}]\runo;
	\draw (axis cs:0,0)--(axis cs:1.5025,0);
	...
	\addplot[color=Dark2-C] table[x index=0,y expr=\thisrowno{1}]\rtres;
	%\addlegendentry{M4\_3226};
