...
\begin{groupplot}[scale only axis,
	...
	] {(axis cs:1.514,1e-4)}{(axis cs: 1.514,10e-4)}{$\mathrm{9\!\times\!10^{-4}}$};
    ...
    %TRANSITIONS
    \def\sc{0.7}
	\bandt{1.5308}{-13e-4}{-2e-4}{$\thh{1}{1}$}{-5}{\sc}{Set1-E}
	\bandt{1.5351}{13e-4}{3e-4}{$\tlh{1}{1}$}{4}{\sc}{Set1-E}
