...
\begin{document}
	\begin{tikzpicture}[decoration={random steps,segment length=1mm,amplitude=0.3mm}]
		...
		\node at (0,0){\includegraphics{build/RAS-SETUP}};
		...
		%   
		\def\cc{{-6.2,-1.15}}
		\centerarc[thick,decorate,double=gray!20](\cc)(7:60:1.5cm);
		%\centerarc[thick,decorate,gray](-5.5,0.2)(3:60:1.3cm);
		
		
		\centerarc[thick,decorate,double=gray!20](\cc)(75:110:1.5cm);
		%\centerarc[thick,decorate,gray](-5.5,0.2)(75:110:1.3cm);
		
		\centerarc[thick,decorate,double=gray!20](\cc)(120:180:1.5cm);
		%\centerarc[thick,decorate,gray](-5.5,0.2)(120:180:1.3cm);
		
		\centerarc[thick,decorate,double=gray!20](\cc)(190:230:1.5cm);
		%\centerarc[thick,decorate,gray](-5.5,0.2)(190:230:1.3cm);
		
		\centerarc[thick,decorate,double=gray!20](\cc)(250:290:1.5cm);
		%\centerarc[thick,decorate,gray](-5.5,0.2)(250:290:1.3cm);
		
		\centerarc[thick,decorate,double=gray!20](\cc)(300:345:1.5cm);
		%\centerarc[thick,decorate,gray](-5.5,0.2)(300:345:1.3cm);
		
		\draw[decorate,double=gray!20] (-6.9,0)--(-7.8,1.9);
		\draw[decorate,double=gray!20] (-6.6,0.1)--(-7.6,2);
