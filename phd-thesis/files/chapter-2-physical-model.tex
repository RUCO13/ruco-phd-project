...
Now, we focus on the central part either, the core of this work. The asymmetry in structure entails in a very interesting quantum process in these semiconductor structures. The symmetry reduction is the basis of the model in this work, as explained before, the symmetry its the cause of quantum properties in solids, the fact to say symmetry breaking carried to properties of crystals exhibits many interesting pheneomas. 

\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{../figures/chapter-2/model/out/model-scheme}
	\caption{Diagram of trhee principal structures studied in this work, which from brottom to up the OA increases as the one of the wells width to. }
\end{figure}
