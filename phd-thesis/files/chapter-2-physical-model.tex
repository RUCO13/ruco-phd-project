...
\begin{equation}\label{eqn:chapter2-sec-numerical-calculations-scrodinger-discrete}
	-\dfrac{\hbar}{2m^{*}}\left[\dfrac{\psi(z+\delta z)-2\psi(z)+\psi(z-\delta z)}{(\delta z)^2}\right] + V(z)\psi(z)=E\psi(z).
\end{equation}

In the \Cref{eqn:chapter2-sec-numerical-calculations-scrodinger-discrete} it's denoted the changed derivative by numerical difference,  
