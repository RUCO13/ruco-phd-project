...
\emph{invariant} under that \emph{transformation}. The symmetry of the system is made up of all of the transformation operations that leave the system invariant\cite{powell2010symmetry}.
...
\subsection{The Brillouin Zone and the Band Structure}
...
Previously, it's continuously mentioned which band structure calculations are difficult, so,  it will start to change hard word to tricky, this because it's possible to make a very good models and approximations\footnote{Actually, this allows ot make a set of simplifications.} taking into account the symmetry of the system. All to begins  from symmetry, the well-known models to calculate band structure starts from symmetry arguments of crystal or the semiconductor studied, it's here 
