...
Then to solve the $N\times N$ matrix it's the last work, but due to the \emph{tridiagonal} nature reduce the computational effort and exist great algebraic algorithms to solve it as cite{lapack, gnu}. Therefore, this method simplify the solution of any structure with arbirtrary or in our case dependent on band-edge potential. The next important question is over to define the potential profile, as this dependens of semiconductor effective-mass and gap energy we taken the corresponds paramters of several references 

\begin{figure}[H]\label{fig:chapter2-sec-numerical-calculations-harrison-wells}
	\centering
	\includegraphics{../figures/chapter-2/numerical-calculations/out/harrison-wells}
	\caption{}
\end{figure}
