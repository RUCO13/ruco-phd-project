...
\end{subfigure}
	\caption{Probability density of the wave functions and confined energies calculated for \subref{fig:chapter-2-sec-anisotropy-model-results-a} sample  S1 (symmetric DQW)  and \subref{fig:chapter-2-sec-anisotropy-model-results-b} sample A2 (asymmetric DQW)}
