...
Then to solve the $N\times N$ matrix it's the last work, but due to the \emph{tridiagonal} nature reduces the computational effort and thanks to exists great algebraic algorithms to solve it as cite{lapack, gnu}. Therefore, this method simplifies the solution of any structure with arbitrary or in our case dependent on band-edge potential. The next important question is over to define the potential profile, as this dependence of semiconductor effective-mass and gap energy we took the corresponds parameters of several references 


\begin{figure}[H]\label{fig:chapter2-sec-numerical-calculations-harrison-wells}
	\centering
