...
\begin{figure}[H]
	\centering
		\includegraphics[width=\linewidth]{../figures/chapter-2/symmetry/out/sym-1}
...
\begin{figure}[h!]
	\centering
	\begin{subfigure}{\textwidth}
		\includegraphics[width=\linewidth]{../figures/chapter-2/symmetry/out/sym-2}
		\phantomsubcaption\label{subfig:subsubsec:chapter-2-coupled-quantum-wells-a)}
		\phantomsubcaption\label{subfig:subsubsec:chapter-2-coupled-quantum-wells-b)}
	\end{subfigure}
	\caption[CB,VB]
	{
		General scheme to describe a SCQWs structure. In this case, the barriers are it composed by \algaas and the wells are of GaAs with the same width, while the coupling barrier also composed by \algaas. In top \subref{subfig:subsection-1.2-single-quantum-well-scheme2-a)} denotes both  \gls{CB} and   \gls{VB}  edges profiles over $z$-axis (Real-space) direction. Then in bottom \subref{subfig:subsection-1.2-single-quantum-well-scheme2-b)}, it represents the atoms structure to CQWs. 
	}\label{fig:subsubsec:chapter-2-coupled-quantum-wells}
\end{figure}
