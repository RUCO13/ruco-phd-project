...
In this section it's important discuss the importance of $C_{2v}$ symmetry, which is the basis of this work. As previously commented, in \gls{ACQWs} posses $C_{2v}$ symmetry point group, and it's this the \emph{holy grail} in solid state semiconductor physics 
