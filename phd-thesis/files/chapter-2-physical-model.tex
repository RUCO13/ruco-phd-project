...
\begin{table}[H]
	\centering
	\includegraphics[width=\textwidth]{../tables/numerical-results/out/numerical-results.pdf}
...
\end{table}
In the \Cref{tab:sec-chapter-2-numerical-results} exposes and compares the numerical results obtained, it's importantly to remark that the calculations was performed at 30K, this due to the central experiments are the RAS, and this experiments was measured at these temperature, by this reason the paramaters involves are well defined as a function of temperature. The numerical direct transitions (\gls{x}) calculated, also consider the exciton binding energy. From et al. take the exciton binding as a function of well width
\begin{figure}[H]
	\centering
	\begin{subfigure}{\textwidth}
