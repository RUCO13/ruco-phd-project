...
To enter into discussion, it  purpose  to focus over three samples, aiming to expose the principal objective of this work, which is denoted the \gls{RAS} strength in \gls{ACQWs} as importance in the  optical properties and excitonic effects in these structures. In the \Cref{fig:chapter-3-subsec-ras-plots-set-3

\begin{figure}[H]
\floatbox[{\capbeside\thisfloatsetup{capbesideposition={right,top},capbesidewidth=0.4\textwidth}}]{figure}[0.95\FBwidth]
{\caption{The RAS results of the samples in order from top to bottom SCQWs, ACQWs-1 and AQCWs-2 respectively. In this plot, it's totally evident the strength of RAS spectra as a function of asymmetric into structure}\label{fig:chapter-3-subsec-ras-plots-set-3}}
