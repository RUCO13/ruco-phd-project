...
\begin{table}[hbtp!]
	...
	\caption{Comparison table between experimental transitions obtained trough PL measurements and numerical transitions calculated as explained in \Cref{sec:chapter-2-numerical-calculations}}
...
\begin{figure}[hb!]
	...
	\caption[RAS Scheme]{
		...
		RAS setup implemented in this work, as in the PR setup, this is a dark configuration this due that photo-detector are exposed, then keeping to ambient light off. The optical array is the same as PR, with the difference the role of polarization and PEM. This figure also shows the incidence angle which is about of $4.5^{\circ}$ and the directions
