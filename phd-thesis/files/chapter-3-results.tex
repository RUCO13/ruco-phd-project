...
The first RAS results even they are a asymmetric CQWs structure, the  RAS spectra it's higher in the samples with AlAs barier (\sm{3172} and \sm{3226}), then the potential barrier is higher than in the sample \sm{3171}, but the width of these barriers is small, therefore we have a case with great potential coupled barrier and 
