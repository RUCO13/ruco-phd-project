...
\begin{figure}[H]
	...
	{\caption{The RAS results of the samples in order from  bottom to top
	\subref{subfig:chapter-3-subsubsec-ras-strength-set-3-a} AQCWs-2, 
	\subref{subfig:chapter-3-subsubsec-ras-strength-set-3-b} ACQWs-1 and \subref{subfig:chapter-3-subsubsec-ras-strength-set-3-c} SCQWs respectively. In this plot, it's totally evident the strength of RAS spectra as the relative widths of the QWs increase (more asymmetric structure).}\label{fig:chapter-3-subsec-ras-plots-set-3}}
	{
