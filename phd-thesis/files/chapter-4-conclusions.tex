...
Finally, from the \gls{RAS} experiments it is clearly the wonderful physics that exhibits \gls{ACQWs}
...
\end{figure}
The first results obtained on \gls{ACQWs}-2 sample  \Cref{fig:chapter-4-subsec-conclusion-ras-spin-1}. 
% these experiments were it performed with the sample position in a preferential direction $[110]$
