...
%\usepackage[left=2.5cm,right=2.5cm,top=2.5cm,bottom=1cm,includefoot,includehead,headheight=14.5pt]{geometry}
\usepackage{miama}
\usepackage{calligra}
...
\usepackage[abbreviations,symbols,nogroupskip,nomain,automake]{glossaries-extra}
...
%    \begin{longtable}{lp{\glsdescwidth}>{\centering\arraybackslash}p{2.5cm}}}%
%    {\end{longtable}}%
%  %
