...
\begin{tikzpicture}[remember picture, overlay]
	...
	\node[scale=1.8,font=\bfseries,text width=0.4\textwidth,align=center,anchor=center,yshift=3cm,xshift=0mm](title) at (current page.center){Coupled quantum wells as a novel source of optical anisotropies in unperturbed nanostructured systems};
