...
\begin{tikzpicture}[remember picture, overlay]
	...
	\node[scale=1.8,font=\bfseries,text width=0.42\linewidth,align=center,anchor=center,yshift=3cm,xshift=3mm](title) at (current page.center){Optical anisotropy study\\ in coupled quantum wells,\\ a novel source of undisturbed systems};
	...
	\node[scale=1.2,anchor=south,yshift=-50mm](city) at (supvisor3.south) {\textsc{San Luis Potos\'i, S.L.P. M\'exico} };
	\node[scale=1.2,anchor=north,yshift=0mm](year) at (city.south) {\textsc{MARCH 2022}  };
\end{tikzpicture}
\end{titlepage}
