...
\begin{tikzpicture}[remember picture, overlay]
	...
	\node[scale=1.25,anchor=north,yshift=-2mm](supvisor2) at (supvisor1.south){Dr. Edgar Armando Cerda M\'endez};
	\node[scale=1.2,anchor=south,yshift=-50mm](city) at (supvisor2.south) {\textsc{San Luis Potos\'i, S.L.P. M\'exico} };
	\node[scale=1.2,anchor=north,yshift=0mm](year) at (city.south) {\textsc{JANUARY 2022}  };
\end{tikzpicture}
\end{titlepage}
